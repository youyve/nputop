...
Examples:
    >>> from nputop import Device, CudaDevice
...
class Device:  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def uuid(self) -> str | NaType:
        ...
        Returns: Union[str, NaType]
            The UUID of the device, or :const:`nputop.NA` when not applicable.
    ...
    def bus_id(self) -> str | NaType:
        ...
        Returns: Union[str, NaType]
            The PCI bus ID of the device, or :const:`nputop.NA` when not applicable.
    ...
    def serial(self) -> str | NaType:
        ...
        Returns: Union[str, NaType]
            The serial number of the device, or :const:`nputop.NA` when not applicable.
    ...
    def memory_info(self) -> MemoryInfo:  # in bytes
        ...
        Returns: MemoryInfo(total, free, used)
            A named tuple with memory information, the item could be :const:`nputop.NA` when not applicable.
        """
    ...
    def memory_used(self) -> int | NaType:  # in bytes
        ...
        Returns: Union[int, NaType]
            Total memory allocated by active contexts in bytes, or :const:`nputop.NA` when not applicable.
    ...
    def memory_free(self) -> int | NaType:  # in bytes
        ...
        Returns: Union[int, NaType]
            Total free memory in bytes, or :const:`nputop.NA` when not applicable.
    ...
    def memory_used_human(self) -> str | NaType:  # in human readable
        ...
        Returns: Union[int, NaType]
            Total memory allocated by active contexts in human readable format, or :const:`nputop.NA` when not applicable.
        """  # pylint: disable=line-too-long
    ...
    def memory_free_human(self) -> str | NaType:  # in human readable
        ...
        Returns: Union[int, NaType]
            Total free memory in human readable format, or :const:`nputop.NA` when not applicable.
        """
    ...
    def memory_percent(self) -> float | NaType:  # in percentage
        ...
        Returns: Union[float, NaType]
            The percentage of used memory over total memory, or :const:`nputop.NA` when not applicable.
        """
    ...
    def bar1_memory_info(self) -> MemoryInfo:  # in bytes
        ...
        Returns: MemoryInfo(total, free, used)
            A named tuple with BAR1 memory information, the item could be :const:`nputop.NA` when not applicable.
        """  # pylint: disable=line-too-long
    ...
    def bar1_memory_total(self) -> int | NaType:  # in bytes
        ...
        Returns: Union[int, NaType]
            Total BAR1 memory in bytes, or :const:`nputop.NA` when not applicable.
        """
    ...
    def bar1_memory_used(self) -> int | NaType:  # in bytes
        ...
        Returns: Union[int, NaType]
            Total used BAR1 memory in bytes, or :const:`nputop.NA` when not applicable.
        """
    ...
    def bar1_memory_free(self) -> int | NaType:  # in bytes
        ...
        Returns: Union[int, NaType]
            Total free BAR1 memory in bytes, or :const:`nputop.NA` when not applicable.
        """
    ...
    def bar1_memory_total_human(self) -> str | NaType:  # in human readable
        ...
        Returns: Union[int, NaType]
            Total BAR1 memory in human readable format, or :const:`nputop.NA` when not applicable.
        """
    ...
    def bar1_memory_used_human(self) -> str | NaType:  # in human readable
        ...
        Returns: Union[int, NaType]
            Total used BAR1 memory in human readable format, or :const:`nputop.NA` when not applicable.
        """
    ...
    def bar1_memory_free_human(self) -> str | NaType:  # in human readable
        ...
        Returns: Union[int, NaType]
            Total free BAR1 memory in human readable format, or :const:`nputop.NA` when not applicable.
        """
    ...
    def bar1_memory_percent(self) -> float | NaType:  # in percentage
        ...
        Returns: Union[float, NaType]
            The percentage of used BAR1 memory over total BAR1 memory, or :const:`nputop.NA` when not applicable.
        """  # pylint: disable=line-too-long
    ...
    def encoder_utilization(self) -> int | NaType:  # in percentage
        ...
        Returns: Union[int, NaType]
            The encoder utilization rate  in percentage, or :const:`nputop.NA` when not applicable.
        """
    ...
    def decoder_utilization(self) -> int | NaType:  # in percentage
        ...
        Returns: Union[int, NaType]
            The decoder utilization rate  in percentage, or :const:`nputop.NA` when not applicable.
        """
    ...
    def clock_infos(self) -> ClockInfos:  # in MHz
        ...
        Returns: ClockInfos(graphics, sm, memory, video)
            A named tuple with current clock speeds (in MHz) for the device, the item could be :const:`nputop.NA` when not applicable.
        """  # pylint: disable=line-too-long
        return ClockInfos(
    ...
    def max_clock_infos(self) -> ClockInfos:  # in MHz
        ...
        Returns: ClockInfos(graphics, sm, memory, video)
            A named tuple with maximum clock speeds (in MHz) for the device, the item could be :const:`nputop.NA` when not applicable.
        """  # pylint: disable=line-too-long
    ...
    def graphics_clock(self) -> int | NaType:  # in MHz
        ...
        Returns: Union[int, NaType]
            The current frequency of graphics (shader) clock in MHz, or :const:`nputop.NA` when not applicable.
    ...
    def sm_clock(self) -> int | NaType:  # in MHz
        ...
        Returns: Union[int, NaType]
            The current frequency of SM (Streaming Multiprocessor) clock in MHz, or :const:`nputop.NA` when not applicable.
    ...
    def memory_clock(self) -> int | NaType:  # in MHz
        ...
        Returns: Union[int, NaType]
            The current frequency of memory clock in MHz, or :const:`nputop.NA` when not applicable.
    ...
    def video_clock(self) -> int | NaType:  # in MHz
        ...
        Returns: Union[int, NaType]
            The current frequency of video encoder/decoder clock in MHz, or :const:`nputop.NA` when not applicable.
    ...
    def max_graphics_clock(self) -> int | NaType:  # in MHz
        ...
        Returns: Union[int, NaType]
            The maximum frequency of graphics (shader) clock in MHz, or :const:`nputop.NA` when not applicable.
    ...
    def max_sm_clock(self) -> int | NaType:  # in MHz
        ...
        Returns: Union[int, NaType]
            The maximum frequency of SM (Streaming Multiprocessor) clock in MHz, or :const:`nputop.NA` when not applicable.
    ...
    def max_memory_clock(self) -> int | NaType:  # in MHz
        ...
        Returns: Union[int, NaType]
            The maximum frequency of memory clock in MHz, or :const:`nputop.NA` when not applicable.
    ...
    def max_video_clock(self) -> int | NaType:  # in MHz
        ...
        Returns: Union[int, NaType]
            The maximum frequency of video encoder/decoder clock in MHz, or :const:`nputop.NA` when not applicable.
    ...
    def fan_speed(self) -> int | NaType:  # in percentage
        ...
        Returns: Union[int, NaType]
            The fan speed value in percentage, or :const:`nputop.NA` when not applicable.
    ...
    def power_usage(self) -> int | NaType:  # in milliwatts (mW)
        ...
        Returns: Union[int, NaType]
            The power draw for the entire board in milliwatts, or :const:`nputop.NA` when not applicable.
    ...
    def power_limit(self) -> int | NaType:  # in milliwatts (mW)
        ...
        Returns: Union[int, NaType]
            The software power limit in milliwatts, or :const:`nputop.NA` when not applicable.
    ...
    def pcie_throughput(self) -> ThroughputInfo:  # in KiB/s
        ...
        Returns: ThroughputInfo(tx, rx)
            ...
            :const:`nputop.NA` when not applicable.
        """
    ...
    def pcie_tx_throughput(self) -> int | NaType:  # in KiB/s
        ...
        Returns: Union[int, NaType]
            The current PCIe transmit throughput in KiB/s, or :const:`nputop.NA` when not applicable.
        """
        return libnvml.nvmlQuery(
    ...
    def pcie_rx_throughput(self) -> int | NaType:  # in KiB/s
        ...
        Returns: Union[int, NaType]
            The current PCIe receive throughput in KiB/s, or :const:`nputop.NA` when not applicable.
        """
        return libnvml.nvmlQuery(
            'nvmlDeviceGetPcieThroughput',
            self.handle,
    ...
    def pcie_tx_throughput_human(self) -> str | NaType:  # in human readable
        ...
        Returns: Union[str, NaType]
            The current PCIe transmit throughput in human readable format, or :const:`nputop.NA`
            when not applicable.
        """
    ...
    def pcie_rx_throughput_human(self) -> str | NaType:  # in human readable
        ...
        Returns: Union[str, NaType]
            The current PCIe receive throughput in human readable format, or :const:`nputop.NA` when
            not applicable.
        """
    ...
    def nvlink_throughput(
        ...
        Returns: List[ThroughputInfo(tx, rx)]
            ...
            could be :const:`nputop.NA` when not applicable.
        """
    ...
    def nvlink_total_throughput(
        ...
        Returns: ThroughputInfo(tx, rx)
            ...
            be :const:`nputop.NA` when not applicable.
        """
        tx_throughputs = []
        rx_throughputs = []
    ...
    def display_active(self) -> str | NaType:
        ...
        Returns: Union[str, NaType]
            ...
            - :const:`nputop.NA`: if not applicable.
    ...
    def current_driver_model(self) -> str | NaType:
        ...
        Returns: Union[str, NaType]
            ...
            - :const:`nputop.NA`: if not applicable, e.g. on Linux.
    ...
    def total_volatile_uncorrected_ecc_errors(self) -> int | NaType:
        ...
        Returns: Union[int, NaType]
            The total number of uncorrected errors in volatile ECC memory, or :const:`nputop.NA` when not applicable.
    ...
    def cuda_compute_capability(self) -> tuple[int, int] | NaType:
        ...
        Returns: Union[Tuple[int, int], NaType]
            The CUDA compute capability version in format ``(major, minor)``, or :const:`nputop.NA` when not applicable.
...
class MigDevice(Device):  # pylint: disable=too-many-instance-attributes
    ...
    def compute_instance_id(self) -> int | NaType:
        ...
        Returns: Union[int, NaType]
            The compute instance ID of the MIG device, or :const:`nputop.NA` when not applicable.
        """
