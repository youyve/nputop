...
class NaType(str):
    ...
    def __new__(cls) -> NaType:  # noqa: PYI034
        """Get the singleton instance (:const:`nputop.NA`)."""
    ...
    def __add__(self, other: object) -> str | float:  # type: ignore[override]
        ...
        A special case is when the operand is :const:`nputop.NA` itself, the result is
    ...
    def __mul__(self, other: object) -> float:  # type: ignore[override]
        ...
        A special case is when the operand is :const:`nputop.NA` itself, the result is also :data:`math.nan`.
    ...
    def __round__(self, ndigits: int | None = None) -> int | float:
        """Round :const:`nputop.NA` to ``ndigits`` decimal places, defaulting to :const:`0`.
    ...
    def __lt__(self, x: object) -> bool:
        """The :const:`nputop.NA` is always greater than any number, or uses the dictionary order for string."""
    ...
    def __format__(self, format_spec: str) -> str:
        """Format :const:`nputop.NA` according to ``format_spec``."""
        try:
